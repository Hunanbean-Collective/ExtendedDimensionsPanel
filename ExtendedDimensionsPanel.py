bl_info = {
    "name": "Dimensions Panel Extended",
    "author": "Hunanbean, with ChatGPT4",
    "version": (1, 0),
    "blender": (3, 3, 0),
    "description": "Add a Dimensions panel to the Object Properties with Apply Scale, Rotation and Location buttons Due to Blender design, I cannot seem to add it directly to the existing Transform Panel. It must be its own",
    "category": "Object",
